...
const OverviewSection = () => {
  ...
  const shortText = eventData.overview.slice(0, 300) + "...";
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="lg:w-[70%]">
            ...
            <div className="text-body leading-relaxed whitespace-pre-line">
              {expanded ? eventData.overview : shortText}
            </div>
            ...
            <div className="lg:sticky lg:top-6 bg-card border border-border rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold text-heading">
                    {eventData.maxAttendees.toLocaleString()}
                  </span>
                </div>
              </div>

              <Button variant="saffron" className="w-full mb-3" size="lg">
                Register Now
              </Button>
              ...
              <div className="flex items-center gap-2 justify-center">
                ...
                <span className="text-sm font-medium text-highlight">
                  {eventData.spotsRemaining} spots remaining
                </span>
              </div>
            </div>
          </div>
